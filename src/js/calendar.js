...
Cal.prototype.showMonth = function (y, m) {
    ...
    do {
        ...
        html += `<td class="${targetDateClass}" data-date="${i}" onclick="selectDate(event, ${i},${m})">${i}</td>`;
...
function selectDate(event, day, m) {
    ...
    dateContainer.innerHTML = `${day} ${new Cal().MonthsDate[m]}`;
}
